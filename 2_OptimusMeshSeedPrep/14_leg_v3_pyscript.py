    ...
    mytuple = tuple (edges_list)
    p.seedEdgeByNumber(edges=mytuple, number=32, constraint=FINER)
    pickedEdges = e.getClosest (coordinates=(($PNT_8_1_XCOORD$, 0, $PNT_8_1_ZCOORD$), ($PNT_8_2_XCOORD$, 0, $PNT_8_2_ZCOORD$), ($PNT_8_3_XCOORD$, 0, $PNT_8_3_ZCOORD$), ))
    edges_list = []
    for item in pickedEdges.values():
        edges_list.append(item[0])
    mytuple = tuple (edges_list)
    ...
    mytuple = tuple (edges_list)
    p.seedEdgeByNumber(edges=mytuple, number=32, constraint=FINER)
    distToSym_1 = $PNT_MID_1_XCOORD$ - $PNT_8_1_XCOORD$
    distToSym_2 = $PNT_MID_1_XCOORD$ - $PNT_8_2_XCOORD$
    distToSym_3 = $PNT_MID_1_XCOORD$ - $PNT_8_3_XCOORD$
    pickedEdges = e.getClosest (coordinates=(($PNT_8_1_XCOORD$ + 2*distToSym_1, 0, $PNT_8_1_ZCOORD$), ($PNT_8_2_XCOORD$ + 2*distToSym_2, 0, $PNT_8_2_ZCOORD$), ($PNT_8_3_XCOORD$ + 2*distToSym_3, 0, $PNT_8_3_ZCOORD$), ))
    edges_list = []
    for item in pickedEdges.values():
        edges_list.append(item[0])
    mytuple = tuple (edges_list)
